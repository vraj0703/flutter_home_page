...
// Stair line config: narrower + dimmer + tighter spacing as they recede (forced perspective stairs)
const STAIR_LINES = [
  { z: 0,     w: 3.4, h: 0.012, brightness: 1.0  },
  { z: -1.3,  w: 2.8, h: 0.010, brightness: 0.75 },
  { z: -2.3,  w: 2.3, h: 0.008, brightness: 0.55 },
  { z: -3.1,  w: 1.8, h: 0.007, brightness: 0.38 },
  { z: -3.7,  w: 1.3, h: 0.006, brightness: 0.24 },
  { z: -4.2,  w: 0.9, h: 0.005, brightness: 0.14 },
]
